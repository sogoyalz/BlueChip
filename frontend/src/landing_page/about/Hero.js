...
function Hero() {
  return (
    <div className="container">
      ...
      style ={{lineHeight:'1.8', frontSize:"1.2em"}}>
        <div className="col-6 p-5">
          <p>
            We kick-started operations on the 15th of August, 2010 with the goal
            of breaking all barriers that traders and investors face in India in
            terms of cost, support, and technology. We named the company
            BlueChip, after the "blue chip" stocks that stand for stability,
            trust, and long-term value. </p>
            <p>Today, our disruptive pricing models and in-house
            technology have made us the biggest stock broker in India.</p>
            <p>TOver 1.6+ crore clients place billions of orders every year through our
